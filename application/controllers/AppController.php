...
class AppController extends CI_Controller {
	...
	public function receiving_daily_breakdown() {
        ...
        $data['link'] = "{$this->efi_server}/EFIReports/Pages/ReportViewer.aspx?%2fEFIReports%2fReceivingDailyBreakdown&rs:Command=Render";
	...
	public function supplier_deliveries() {
        ...
        $data['link'] = "{$this->efi_server}/EFIReports/Pages/ReportViewer.aspx?%2fEFIReports%2fSupplierDeliveries&rs:Command=Render";
	...
	public function supplier_tonnage_summary() {
        ...
        $data['link'] = "{$this->efi_server}/EFIReports/Pages/ReportViewer.aspx?%2fEFIReports%2fSupplierTonageSummary&rs:Command=Render";
